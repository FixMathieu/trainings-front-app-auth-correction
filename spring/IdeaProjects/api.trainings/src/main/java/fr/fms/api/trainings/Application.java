...
//
//		detailsRepository.save(new Details(null,n1,myOrder));
//		detailsRepository.save(new Details(null,n2,myOrder));
//		detailsRepository.save(new Details(null,n3,myOrder));
//		detailsRepository.save(new Details(null,n4,myOrder));
	}
}
